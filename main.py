...
#     # --- 2. Validação para o PERCEPTRON SIMPLES (Pessoa 0 vs Resto) ---
...
#     # --- 3. Validação para o MADALINE MULTICLASSE (20 Pessoas) ---
...
# ==========================================
# 1. CONFIGURAÇÕES DA SIMULAÇÃO (R=100)
# ==========================================
R = 10
n_samples = X_faces.shape[0]
n_treino = int(0.8 * n_samples)
...
for r in range(R):
    ...
    # ------------------------------------------
    # MODELO 2: MADALINE MULTICLASSE (20 Pessoas)
    # ------------------------------------------
    ...
    # ------------------------------------------
    # MODELO 3: MLP (20 Pessoas)
    # ------------------------------------------
    # Usando o Target transposto (amostra x classe) para o seu MLP
    d_train_hot_mlp = one_hot_encoding(y_train, num_classes=20).T
    dim_entrada = X_train.shape[1] # Garante que pega 1024 ou 2500 corretamente
...
# ==========================================
# 2. CÁLCULO DAS MÉTRICAS E TABELA NO CONSOLE
# ==========================================
print("\n" + "="*70)
...
# ==========================================
# 3. GERAÇÃO DO BOXPLOT (GRÁFICO FINAL)
# ==========================================
